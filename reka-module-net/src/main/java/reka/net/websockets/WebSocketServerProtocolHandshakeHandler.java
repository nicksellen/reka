...
public class WebSocketServerProtocolHandshakeHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(final ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        final WebSocketServerHandshakerFactory wsFactory = new WebSocketServerHandshakerFactory(
                websocketLocation(ctx.pipeline(), req, websocketPath), subprotocols, allowExtensions);
    ...
    private static String websocketLocation(ChannelPipeline pipeline, HttpRequest req, String path) {
        String protocol = "ws";
