...
import static reka.javascript.JavascriptRhinoHelper.runJavascriptInScope;
...
public class UseJavascript extends UseConfigurer {
	...
	public void setup(UseInit init) {
		...
		init.operation(asList("", "run"), () -> new JavascriptConfigurer(scopePath));
